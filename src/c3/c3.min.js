!(function(t, e) {
  ...
  function e(t) {
    ...
    e.loadConfig(
      t
    ), e.beforeInit(t), e.init(), e.afterInit(t), (function t(e, i, n) {
  ...
  function i(t) {
    ...
    ;(e.d3 = window.d3
      ...
      : 'undefined' != typeof require
        ? require('d3')
        : void 0), (e.api = t), (e.config = e.getDefaultConfig()), (e.data = {}), (e.cache = {}), (e.axes = {})
  }
  var n,
    a,
    r = {
  ...
  ;((a = t.prototype).axisX = function(t, e, i) {
    ...
    var t,
      e = this,
      i = e.scale.copy()
    return e.params.isCategory &&
      ((t = e.scale.domain()), i.domain([t[0], t[1] - 1])), i
    ...
    var t = this
    return (t.range = t.scale.rangeExtent
      ? t.scale.rangeExtent()
      : t.scaleExtent(t.scale.range())), t.range
    ...
    return '[object Array]' === Object.prototype.toString.call(c)
      ...
      : (
          (!d || d <= 0) &&
            (d = s.isVertical()
              ? 95
              : s.params.isCategory ? Math.ceil(i(e[1]) - i(e[0])) - 12 : 110),
          n(l, c + '')
        )
    ...
    function t(a) {
      a.each(function() {
        ...
        n.isCategory
          ...
          : (e.tickOffset = r = 0), h.append('line'), h.append('text'), e.updateRange(), e.updateTickLength(), e.updateTickTextCharSize(s.select('.tick'))
        var p = f.select('line'),
          _ = f.select('text'),
        ...
        switch (e.orient) {
          case 'bottom':
            ;(a =
              e.axisX), p.attr('x1', r).attr('x2', r).attr('y2', function(t, i) {
              return e.lineY2(t, i)
            }), _.attr('x', 0)
              .attr('y', function(t, i) {
                return e.textY(t, i)
          ...
          case 'top':
            ;(a =
              e.axisX), p.attr('x2', 0).attr('y2', -e.innerTickSize), _.attr('x', 0).attr('y', -e.tickLength).style('text-anchor', 'middle'), x.attr('x', 0).attr('dy', '0em'), y.attr('d', 'M' + e.range[0] + ',' + -e.outerTickSize + 'V0H' + e.range[1] + 'V' + -e.outerTickSize)
            break
          case 'left':
            ;(a =
              e.axisY), p.attr('x2', -e.innerTickSize).attr('y1', o).attr('y2', o), _.attr('x', -e.tickLength).attr('y', e.tickOffset).style('text-anchor', 'end'), x.attr('x', -e.tickLength).attr('dy', function(t, i) {
              return e.tspanDy(t, i)
            }), y.attr(
              'd',
              'M' +
          ...
          case 'right':
            ;(a =
              e.axisY), p.attr('x2', e.innerTickSize).attr('y2', 0), _.attr('x', e.tickLength).attr('y', 0).style('text-anchor', 'start'), x.attr('x', e.tickLength).attr('dy', function(t, i) {
              return e.tspanDy(t, i)
            }), y.attr(
              'd',
              'M' +
    ...
    return (t.scale = function(i) {
      ...
      var i
      return (i = n.isCategory
        ? 2 * e.tickOffset
        : (t.g.select('path.domain').node().getTotalLength() -
            2 * e.outerTickSize) /
          t.g.selectAll('line').size()), i === 1 / 0 ? 0 : i
    }), (t.ticks = function() {
      return arguments.length
  ...
  ;((n = A.prototype).init = function() {
    ...
    return s.isTimeSeries() &&
      n &&
      'function' != typeof n &&
      (n = n.map(function(t) {
        return s.parseDate(t)
      })), l.tickFormat(i).tickValues(n), s.isCategorized() &&
      (
    ...
    var i,
      n = this.owner,
      a = n.config
    return (a.axis_x_tick_fit || a.axis_x_tick_count) &&
      ...
      ? e.tickValues(i)
      : (n.xAxis.tickValues(i), n.subXAxis.tickValues(i)), i
    ...
    g(n)
      ? 'y' === t
        ? (i.axis_y_label = e)
        : 'y2' === t ? (i.axis_y2_label = e) : 'x' === t && (i.axis_x_label = e)
      : n && (n.text = e)
    ...
    return 'y2' === t
      ...
      : 'y' === t ? this.getYAxisLabelPosition() : this.getXAxisLabelPosition()
    ...
    return t.axis_rotated
      ? e.isInner ? '1.2em' : -25 - this.getMaxTickWidth('x')
      : e.isInner ? '-0.5em' : t.axis_x_height ? t.axis_x_height - 10 : '3em'
    ...
    ;(t ? i.transition() : i)
      ...
      .text(this.textForXAxisLabel.bind(this)), (t ? n.transition() : n)
      .attr('x', this.xForYAxisLabel.bind(this))
      .attr('dx', this.dxForYAxisLabel.bind(this))
      .attr('dy', this.dyForYAxisLabel.bind(this))
      .text(this.textForYAxisLabel.bind(this)), (t ? a.transition() : a)
    ...
    return l(a)
      ? 'ratio' === t.unit ? t[e] * n : this.convertPixelsToAxisPadding(a, n)
      : i
    ...
    if (e)
      if (1 === (n = u(e) ? e() : e)) l = [t[0]]
        ...
        for (
          o = n - 2, a = t[0], s = ((r = t[t.length - 1]) - a) / (o + 1), l = [
            a
          ], c = 0;
          c < o;
          c++
    ...
    var i = this.owner
    i.axes.x.style('opacity', e ? 0 : 1), i.axes.y.style(
      'opacity',
      e ? 0 : 1
    ), i.axes.y2.style('opacity', e ? 0 : 1), i.axes.subx.style(
      'opacity',
      e ? 0 : 1
    ), t.axisX.call(i.xAxis), t.axisY.call(i.yAxis), t.axisY2.call(
      i.y2Axis
  ...
  return (L.generate = function(t) {
    ...
    var t = this,
      e = t.d3,
      i = t.config
    ;(t.clipId = 'c3-' + +new Date() + '-clip'), (t.clipIdForXAxis =
      t.clipId + '-xaxis'), (t.clipIdForYAxis =
      t.clipId + '-yaxis'), (t.clipIdForGrid =
      t.clipId + '-grid'), (t.clipIdForSubchart =
      t.clipId + '-subchart'), (t.clipPath = t.getClipPath(
      t.clipId
    )), (t.clipPathForXAxis = t.getClipPath(
      t.clipIdForXAxis
    )), (t.clipPathForYAxis = t.getClipPath(
      t.clipIdForYAxis
    )), (t.clipPathForGrid = t.getClipPath(
      t.clipIdForGrid
    )), (t.clipPathForSubchart = t.getClipPath(
      t.clipIdForSubchart
    )), (t.dragStart = null), (t.dragging = !1), (t.flowing = !1), (t.cancelClick = !1), (t.mouseover = !1), (t.transiting = !1), (t.color = t.generateColor()), (t.levelColor = t.generateLevelColor()), (t.dataTimeFormat = i.data_xLocaltime
      ? e.time.format
      : e.time.format.utc), (t.axisTimeFormat = i.axis_x_localtime
      ? e.time.format
      : e.time.format.utc), (t.defaultAxisTimeFormat = t.axisTimeFormat.multi([
      [
        '.%L',
        function(t) {
    ...
    ])), (t.hiddenTargetIds = []), (t.hiddenLegendIds = []), (t.focusedTargetIds = []), (t.defocusedTargetIds = []), (t.xOrient = i.axis_rotated
      ? 'left'
      : 'bottom'), (t.yOrient = i.axis_rotated
      ? i.axis_y_inner ? 'top' : 'bottom'
      : i.axis_y_inner ? 'right' : 'left'), (t.y2Orient = i.axis_rotated
      ? i.axis_y2_inner ? 'bottom' : 'top'
      : i.axis_y2_inner ? 'left' : 'right'), (t.subXOrient = i.axis_rotated
      ? 'left'
      : 'bottom'), (t.isLegendRight =
      'right' === i.legend_position), (t.isLegendInset =
      'inset' === i.legend_position), (t.isLegendTop =
      'top-left' === i.legend_inset_anchor ||
      'top-right' === i.legend_inset_anchor), (t.isLegendLeft =
      'top-left' === i.legend_inset_anchor ||
      'bottom-left' ===
        i.legend_inset_anchor), (t.legendStep = 0), (t.legendItemWidth = 0), (t.legendItemHeight = 0), (t.currentMaxTickWidths = {
      x: 0,
      y: 0,
      y2: 0
    }), (t.rotated_padding_left = 30), (t.rotated_padding_right =
      i.axis_rotated && !i.axis_x_show
        ? 0
        : 30), (t.rotated_padding_top = 5), (t.withoutFadeIn = {}), (t.intervalForObserveInserted = void 0), (t.axes.subx = e.selectAll(
      []
    ))
  }), (C.initChartElements = function() {
    this.initBar && this.initBar(), this.initLine && this.initLine(), this
      .initArc && this.initArc(), this.initGauge && this.initGauge(), this
    ...
    var e,
      ...
      o = n.config,
      s = !0
    ;(n.axis = new A(n)), n.initPie && n.initPie(), n.initBrush &&
      n.initBrush(), n.initZoom && n.initZoom(), o.bindto
      ? 'function' == typeof o.bindto.node
        ? (n.selectChart = o.bindto)
        : (n.selectChart = a.select(o.bindto))
      : (n.selectChart = a.selectAll([])), n.selectChart.empty() &&
      (
        (n.selectChart = a
      ...
      .classed(
        'c3',
        !0
      ), (n.data.xs = {}), (n.data.targets = n.convertDataToTargets(
      t
    )), o.data_filter &&
      (n.data.targets = n.data.targets.filter(o.data_filter)), o.data_hide &&
      ...
      (o.legend_show = !1), n.updateSizes(), n.updateScales(), n.x.domain(
      a.extent(n.getXDomain(n.data.targets))
    ), n.y.domain(n.getYDomain(n.data.targets, 'y')), n.y2.domain(
      n.getYDomain(n.data.targets, 'y2')
    ), n.subX.domain(n.x.domain()), n.subY.domain(n.y.domain()), n.subY2.domain(
      n.y2.domain()
    ), (n.orgXDomain = n.x.domain()), n.brush &&
      n.brush.scale(n.subX), o.zoom_enabled &&
      n.zoom.scale(n.x), (n.svg = n.selectChart
      .append('svg')
      ...
      n.svg.attr('class', n.config.svg_classname), (e = n.svg.append(
      'defs'
    )), (n.clipChart = n.appendClip(e, n.clipId)), (n.clipXAxis = n.appendClip(
      e,
      n.clipIdForXAxis
    )), (n.clipYAxis = n.appendClip(
      e,
      n.clipIdForYAxis
    )), (n.clipGrid = n.appendClip(
      e,
      n.clipIdForGrid
    )), (n.clipSubchart = n.appendClip(
      e,
      n.clipIdForSubchart
    )), n.updateSvgSize(), (i = n.main = n.svg
      .append('g')
      .attr('transform', n.getTranslate('main'))), n.initSubchart &&
      n.initSubchart(), n.initTooltip && n.initTooltip(), n.initLegend &&
      n.initLegend(), n.initTitle && n.initTitle(), i
      .append('text')
      ...
      .attr(
        'dominant-baseline',
        'middle'
      ), n.initRegion(), n.initGrid(), i
      .append('g')
      .attr('clip-path', n.clipPath)
      .attr('class', r.chart), o.grid_lines_front &&
      n.initGridLines(), n.initEventRect(), n.initChartElements(), i
      .insert('rect', o.zoom_privileged ? null : 'g.' + r.regions)
      .attr('class', r.zoomRect)
      .attr('width', n.width)
      .attr('height', n.height)
      .style('opacity', 0)
      .on('dblclick.zoom', null), o.axis_x_extent &&
      n.brush.extent(n.getDefaultExtent()), n.axis.init(), n.updateTargets(
      n.data.targets
    ), s &&
      (
        n.updateDimension(),
    ...
    ;(t.currentWidth = t.getCurrentWidth()), (t.currentHeight = t.getCurrentHeight()), (t.margin = e.axis_rotated
      ? {
          ...
          bottom:
            t.getHorizontalAxisHeight('y') + a + t.getCurrentPaddingBottom(),
      ...
      bottom: 0,
      left: 0
    }), t.updateSizeForLegend && t.updateSizeForLegend(i, n), (t.width =
      t.currentWidth - t.margin.left - t.margin.right), (t.height =
      t.currentHeight - t.margin.top - t.margin.bottom), t.width < 0 &&
      (t.width = 0), t.height < 0 && (t.height = 0), (t.width2 = e.axis_rotated
      ? t.margin.left - t.rotated_padding_left - t.rotated_padding_right
      : t.width), (t.height2 = e.axis_rotated
      ? t.height
      : t.currentHeight - t.margin2.top - t.margin2.bottom), t.width2 < 0 &&
      (t.width2 = 0), t.height2 < 0 && (t.height2 = 0), (t.arcWidth =
      t.width - (t.isLegendRight ? n + 10 : 0)), (t.arcHeight =
      t.height - (t.isLegendRight ? 0 : 10)), t.hasType('gauge') &&
      !e.gauge_fullCircle &&
      (t.arcHeight += t.height - t.getGaugeLabelHeight()), t.updateRadius &&
      t.updateRadius(), t.isLegendRight &&
      r &&
      (t.margin3.left = t.arcWidth / 2 + 1.1 * t.radiusExpanded)
  }), (C.updateTargets = function(t) {
    var e = this
    e.updateTargetsForText(t), e.updateTargetsForBar(t), e.updateTargetsForLine(
      t
    ), e.hasArcType() &&
      e.updateTargetsForArc &&
      e.updateTargetsForArc(t), e.updateTargetsForSubchart &&
      e.updateTargetsForSubchart(t), e.showTargets()
    ...
    if (
      ...
      if (D.axis_x_tick_culling && C) {
        ...
        I.svg.selectAll('.' + r.axisX + ' .tick text').style('display', 'block')
    ;(_ = I.generateDrawArea
      ? I.generateDrawArea(F, !1)
      : void 0), (x = I.generateDrawBar
      ? I.generateDrawBar(X)
      : void 0), (m = I.generateDrawLine
      ? I.generateDrawLine(M, !1)
      : void 0), (y = I.generateXYForText(
      F,
      X,
      M,
      !0
    )), (S = I.generateXYForText(F, X, M, !1)), i &&
      (
        I.subY.domain(I.getYDomain(H, 'y')),
        I.subY2.domain(I.getYDomain(H, 'y2'))
      ), I.updateXgridFocus(), R.select('text.' + r.text + '.' + r.empty)
      .attr('x', I.width / 2)
      .attr('y', I.height / 2)
      .text(D.data_empty_label_text)
      .transition()
      .style('opacity', H.length ? 0 : 1), I.updateGrid(v), I.updateRegion(
      v
    ), I.updateBar(b), I.updateLine(b), I.updateArea(
      b
    ), I.updateCircle(), I.hasDataLabel() && I.updateText(b), I.redrawTitle &&
      I.redrawTitle(), I.redrawArc && I.redrawArc(v, b, c), I.redrawSubchart &&
      I.redrawSubchart(n, e, v, b, F, X, M), R.selectAll(
      '.' + r.selectedCircles
    )
      .filter(I.isBarType.bind(I))
      .selectAll('circle')
      .remove(), D.interaction_enabled &&
      !t.flow &&
      g &&
      (
        I.redrawEventRect(),
        I.updateZoom && I.updateZoom()
      ), I.updateCircleY(), (E = (I.config.axis_rotated
      ? I.circleY
      : I.circleX).bind(I)), (O = (I.config.axis_rotated
      ? I.circleX
      : I.circleY).bind(I)), t.flow &&
      (P = I.generateFlow({
        targets: H,
        flow: t.flow,
    ...
    var e,
      i = this,
      n = i.config
    ;((t = t || {}).withTransition = w(
      t,
      'withTransition',
      !0
    )), (t.withTransform = w(t, 'withTransform', !1)), (t.withLegend = w(
      t,
      'withLegend',
      !1
    )), (t.withUpdateXDomain = !0), (t.withUpdateOrgXDomain = !0), (t.withTransitionForExit = !1), (t.withTransitionForTransform = w(
      t,
      'withTransitionForTransform',
      t.withTransition
    )), i.updateSizes(), (t.withLegend && n.legend_show) ||
      (
    ...
    var e = (u(this.config.point_show)
    ...
    var e = this,
      i = t.value
    return e.isTimeSeries()
      ? (i = e.parseDate(t.value))
      : e.isCategorized() &&
        'string' == typeof t.value &&
        (i = e.config.axis_x_categories.indexOf(t.value)), Math.ceil(e.x(i))
  }), (C.yv = function(t) {
    var e = this,
    ...
    e && e.axisX
      ? (i = e.axisX)
      : ((i = o.main.select('.' + r.axisX)), t && (i = i.transition())), e &&
    e.axisY
      ? (n = e.axisY)
      : ((n = o.main.select('.' + r.axisY)), t && (n = n.transition())), e &&
    e.axisY2
      ? (a = e.axisY2)
      : ((a = o.main.select('.' + r.axisY2)), t && (a = a.transition())), (t
      ? o.main.transition()
      : o.main).attr('transform', o.getTranslate('main')), i.attr(
      'transform',
      o.getTranslate('x')
    ), n.attr('transform', o.getTranslate('y')), a.attr(
      'transform',
      o.getTranslate('y2')
    ), o.main.select('.' + r.chartArcs).attr('transform', o.getTranslate('arc'))
  }), (C.transformAll = function(t, e) {
    var i = this
    i.transformMain(t, e), i.config.subchart_show &&
      i.transformContext(t, e), i.legend && i.transformLegend(t)
  }), (C.updateSvgSize = function() {
    var t = this,
      e = t.svg.select('.c3-brush .background')
    t.svg
      .attr('width', t.currentWidth)
      .attr('height', t.currentHeight), t.svg
      .selectAll(['#' + t.clipId, '#' + t.clipIdForGrid])
      .select('rect')
      .attr('width', t.width)
      .attr('height', t.height), t.svg
      .select('#' + t.clipIdForXAxis)
      .select('rect')
      .attr('x', t.getXAxisClipX.bind(t))
      .attr('y', t.getXAxisClipY.bind(t))
      .attr('width', t.getXAxisClipWidth.bind(t))
      .attr('height', t.getXAxisClipHeight.bind(t)), t.svg
      .select('#' + t.clipIdForYAxis)
      .select('rect')
      .attr('x', t.getYAxisClipX.bind(t))
      .attr('y', t.getYAxisClipY.bind(t))
      .attr('width', t.getYAxisClipWidth.bind(t))
      .attr('height', t.getYAxisClipHeight.bind(t)), t.svg
      .select('#' + t.clipIdForSubchart)
      .select('rect')
      .attr('width', t.width)
      .attr('height', e.size() ? e.attr('height') : 0), t.svg
      .select('.' + r.zoomRect)
      .attr('width', t.width)
      .attr('height', t.height), t.selectChart.style(
      'max-height',
      t.currentHeight + 'px'
    )
    ...
    t ||
      (e.config.axis_rotated
        ...
        : (
          ...
          )), e.updateSizes(), e.updateScales(), e.updateSvgSize(), e.transformAll(
      !1
    )
    ...
    return t instanceof Date
      ...
      : 'string' == typeof t
        ...
        : 'object' === (void 0 === t ? 'undefined' : o(t))
          ? (e = new Date(+t))
          : 'number' != typeof t || isNaN(t) || (e = new Date(+t)), (e &&
      !isNaN(+e)) ||
      window.console.error("Failed to parse x '" + t + "' to Date object"), e
    ...
    return void 0 !== document.hidden
      ...
      : void 0 !== document.mozHidden
        ...
        : void 0 !== document.msHidden
          ? (t = 'msHidden')
          : void 0 !== document.webkitHidden && (t = 'webkitHidden'), !document[
      t
    ]
  }), (C.isValue = l), (C.isFunction = u), (C.isString = g), (C.isUndefined = f), (C.isDefined = p), (C.ceil10 = _), (C.asHalfPixel = x), (C.diffDomain = m), (C.isEmpty = y), (C.notEmpty = S), (C.notEmpty = S), (C.getOption = w), (C.hasValue = v), (C.sanitise = b), (C.getPathBox = T), (C.CLASS = r), Function
    .prototype.bind ||
    ...
    (
      ...
      (window.SVGPathSegArcAbs = function(t, e, i, n, a, r, o, s) {
        window.SVGPathSeg.call(
          ...
          'A',
          t
        ), (this._x = e), (this._y = i), (this._r1 = n), (this._r2 = a), (this._angle = r), (this._largeArcFlag = o), (this._sweepFlag = s)
      }),
    ...
    (
      (window.SVGPathSegList = function(t) {
        ;(this._pathElement = t), (this._list = this._parsePath(
      ...
      Object.defineProperty(window.SVGPathElement.prototype, 'pathSegList', {
        get: function() {
          return this._pathSegList ||
            (this._pathSegList = new window.SVGPathSegList(this)), this
            ._pathSegList
        },
        enumerable: !0
      }),
      ...
      (window.SVGPathSegList.prototype._writeListToPath = function() {
        this._pathElementMutationObserver.disconnect(), this._pathElement.setAttribute(
          'd',
      ...
      (window.SVGPathSegList.prototype.initialize = function(t) {
        return this._checkPathSynchronizedToList(), (this._list = [
          t
        ]), (t._owningPathSegList = this), this._writeListToPath(), t
      }),
      ...
      (window.SVGPathSegList.prototype.getItem = function(t) {
        return this._checkPathSynchronizedToList(), this._checkValidIndex(
          t
        ), this._list[t]
      }),
      (window.SVGPathSegList.prototype.insertItemBefore = function(t, e) {
        return this._checkPathSynchronizedToList(), e > this.numberOfItems &&
          (e = this.numberOfItems), t._owningPathSegList &&
          (t = t.clone()), this._list.splice(
          e,
          0,
          t
        ), (t._owningPathSegList = this), this._writeListToPath(), t
      ...
      (window.SVGPathSegList.prototype.replaceItem = function(t, e) {
        return this._checkPathSynchronizedToList(), t._owningPathSegList &&
          (t = t.clone()), this._checkValidIndex(e), (this._list[
          e
        ] = t), (t._owningPathSegList = this), this._writeListToPath(), t
      }),
      ...
      (window.SVGPathSegList.prototype._parsePath = function(t) {
        ...
        var n = function(t) {
          ;(this._string = t), (this._currentIndex = 0), (this._endIndex = this._string.length), (this._previousCommand =
            window.SVGPathSeg.PATHSEG_UNKNOWN), this._skipOptionalSpaces()
        }
        ;(n.prototype._isCurrentSpace = function() {
          ...
          if (
            ...
            if (
              ...
              for (
                ...
                (t *= 10), (t +=
                  this._string.charAt(this._currentIndex) - '0'), this
                  ._currentIndex++
            }
            var l = e + n
            if (
          ...
          switch (((this._previousCommand = i), i)) {
            ...
            case window.SVGPathSeg.PATHSEG_CLOSEPATH:
              return this._skipOptionalSpaces(), new window.SVGPathSegClosePath(
                e
              )
    ...
    'object' === (void 0 === t ? 'undefined' : o(t))
      ...
      : (i.axis_y_max = i.axis_y2_max = t), e.redraw({
      withUpdateOrgXDomain: !0,
      withUpdateXDomain: !0
    })
    ...
    'object' === (void 0 === t ? 'undefined' : o(t))
      ...
      : (i.axis_y_min = i.axis_y2_min = t), e.redraw({
      withUpdateOrgXDomain: !0,
      withUpdateXDomain: !0
    })
  }), (P.axis.range = function(t) {
    if (!arguments.length) return { max: this.axis.max(), min: this.axis.min() }
    void 0 !== t.max && this.axis.max(t.max), void 0 !== t.min &&
      this.axis.min(t.min)
  }), (P.category = function(t, e) {
    var i = this.internal,
      n = i.config
    return arguments.length > 1 && ((n.axis_x_categories[t] = e), i.redraw()), n
      .axis_x_categories[t]
    ...
    ;(e.size_width = t ? t.width : null), (e.size_height = t
      ? t.height
      : null), this.flush()
  }), (P.flush = function() {
    ...
    return t.selectChart.classed('c3', !1).html(''), Object.keys(
      t
    ).forEach(function(e) {
      t[e] = null
    }), null
    ...
    return this.internal.clearLegendItemTextBoxCache(), this.internal.updateDataAttributes(
      'names',
      t
    )
    ...
    ;(e = c.convertDataToTargets(i, !0)), c.data.targets.forEach(function(t) {
      ...
      for (i = 0; i < e.length; i++)
        if (t.id === e[i].id) {
          for (
            a = !0, t.values[t.values.length - 1] &&
              (g = t.values[t.values.length - 1].index + 1), h =
              e[i].values.length, n = 0;
            n < h;
            n++
          )
            (e[i].values[n].index = g + n), c.isTimeSeries() ||
              (e[i].values[n].x = g + n)
      ...
      }), (c.data.targets = c.data.targets.concat(
      e
    )), c.getMaxDataCount(), (r = (a = c.data.targets[0]).values[0]), void 0 !==
    t.to
      ? (
          (h = 0),
      ...
      : (
          ...
          (n = [r.x - o, r.x]),
          c.updateXDomain(null, !0, !0, !1, n)
        ), c.updateTargets(c.data.targets), c.redraw({
      flow: {
        index: r.index,
        length: h,
    ...
    return function() {
      ...
      ;(e.flowing = !0), e.data.targets.forEach(function(t) {
        t.values.splice(0, v)
      }), (s = e.updateXDomain(c, !0, !0)), e.updateXGrid &&
        e.updateXGrid(!0), d.orgDataCount
        ? (a =
            1 === d.orgDataCount || (b && b.x) === (T && T.x)
              ? e.x(A[0]) - e.x(s[0])
              : e.isTimeSeries() ? e.x(A[0]) - e.x(s[0]) : e.x(b.x) - e.x(T.x))
        : 1 !== e.data.targets[0].values.length
          ...
          : e.isTimeSeries()
            ...
            : (a = m(s) / 2), (S = m(A) / m(s)), (o =
        'translate(' + a + ',0) scale(' + S + ',1)'), e.hideXGridFocus(), n
        .transition()
        .ease('linear')
        .duration(P)
        .each(function() {
          L.add(
            e.axes.x.transition().call(e.xAxis)
          ), L.add(I.transition().attr('transform', o)), L.add(R.transition().attr('transform', o)), L.add(k.transition().attr('transform', o)), L.add(D.transition().attr('transform', o)), L.add(O.transition().attr('transform', o)), L.add(E.filter(e.isRegionOnX).transition().attr('transform', o)), L.add(V.transition().attr('transform', o)), L.add(G.transition().attr('transform', o))
        })
        .call(L, function() {
          var t,
            n = [],
    ...
    var e = this.internal
    ;(t = e.mapToTargetIds(t)), e.svg
      .selectAll(e.selectorTargets(t.filter(e.isTargetToShow, e)))
      .classed(r.focused, !1)
      .classed(r.defocused, !0), e.hasArcType() &&
      e.unexpandArc(t), e.toggleFocusLegend(
      t,
      !1
    ...
    ;(t = e.mapToTargetIds(t)), e.svg
      ...
      .classed(r.focused, !1)
      .classed(r.defocused, !1), e.hasArcType() && e.unexpandArc(t), e.config
      .legend_show &&
      (
      ...
      ), (e.focusedTargetIds = []), (e.defocusedTargetIds = [])
  }), (P.xgrids = function(t) {
    var e = this.internal,
      i = e.config
    return t
    ...
    var e = this.internal,
      i = e.config
    t.xs && e.addXs(t.xs), 'names' in t &&
      P.data.names.bind(this)(t.names), 'classes' in t &&
      Object.keys(t.classes).forEach(function(e) {
        i.data_classes[e] = t.classes[e]
      }), 'categories' in t &&
      e.isCategorized() &&
      (i.axis_x_categories = t.categories), 'axes' in t &&
    ...
    ;(t = t || {}) instanceof Array
      ? (t = { ids: t })
      : 'string' == typeof t && (t = { ids: [t] }), e.unload(
      e.mapToTargetIds(t.ids),
      function() {
        e.redraw({
          withUpdateOrgXDomain: !0,
          withUpdateXDomain: !0,
    ...
    var e = this.internal,
      i = e.config
    return t
      ? ((i.regions = i.regions.concat(t)), e.redrawWithoutRescale(), i.regions)
      : i.regions
    ...
    return (t = t || {}), (e = a.getOption(
    ...
    )), (i = a.getOption(t, 'classes', [r.region])), (n = a.main
      .select('.' + r.regions)
      .selectAll(
        i.map(function(t) {
          return '.' + t
      ...
      .style('opacity', 0)
      .remove(), (o.regions = o.regions.filter(function(t) {
      var e = !1
      return (
        !t.class ||
        (
    ...
    var i,
      n = this.internal
    ;(t = n.mapToTargetIds(t)), (e = e || {}), n.removeHiddenTargetIds(
      t
    ...
    var i,
      n = this.internal
    ;(t = n.mapToTargetIds(t)), (e = e || {}), n.addHiddenTargetIds(
      t
    ), (i = n.svg.selectAll(n.selectorTargets(t)))
      .transition()
    ...
    t.mouse && (i = t.mouse), t.data
      ...
      : void 0 !== t.x
        ? (e = n.getIndexByX(t.x))
        : void 0 !== t.index && (e = t.index), n.dispatchEvent(
      'mouseover',
      e,
      i
    ), n.dispatchEvent('mousemove', e, i), n.config.tooltip_onshow.call(
      n,
      t.data
    )
    ...
    ;(r.withTransitionForTransform = !1), (n.transiting = !1), n.setTargetType(
      t,
      e
    ), n.updateTargets(n.data.targets), n.updateAndRedraw(r)
  }), (P.x = function(t) {
    var e = this.internal
    return arguments.length &&
      (
    ...
    void 0 !== t.max && this.domain.max(t.max), void 0 !== t.min &&
    ...
    ;(t.radiusExpanded = Math.min(t.arcWidth, t.arcHeight) / 2), (t.radius =
      0.95 * t.radiusExpanded), (t.innerRadiusRatio = i
      ? (t.radius - i) / t.radius
      : 0.6), (t.innerRadius =
    ...
    var t = this
    ;(t.svgArc = t.getSvgArc()), (t.svgArcExpanded = t.getSvgArcExpanded()), (t.svgArcExpandedSub = t.getSvgArcExpanded(
      0.98
    ))
    ...
    return e.isDonutType(t)
      ...
      : e.isGaugeType(t)
        ...
        : e.isPieType(t) ? i.pie_expand_duration : 50
    ...
    var t = this,
      e = t.config,
      i = !0
    return t.hasType('donut')
      ? (i = e.donut_label_show)
      : t.hasType('pie') && (i = e.pie_label_show), i
    ...
    return t.hasType('gauge')
      ? (i = e.gauge_label_format)
      : t.hasType('donut') && (i = e.donut_label_format), i
    ...
    ;(t.arcs = t.main
      ...
      .attr('transform', t.getTranslate('arc'))), t.arcs
      .append('text')
    ...
    ;(n = c
      ...
      .each(function(t) {
        a.isGaugeType(t.data) &&
          (t.startAngle = t.endAngle =
            s.gauge_startingAngle), (this._current = t)
      }), n
      ...
      .call(a.endall, function() {
        a.transiting = !1
      }), n.exit().transition().duration(e).style('opacity', 0).remove(), c
      .selectAll('.' + r.chartArc)
      .select('text')
      .style('opacity', 0)
      .attr('class', function(t) {
    ...
    return function(t) {
      ...
      return n[i] instanceof Function
        ? (e = n[i](t))
        : n[i]
          ? (e = n[i])
          : (
      ...
      ;(i =
        'json' === o
          ...
          : 'tsv' === o
            ...
            : r.convertCsvToData(s)), a.call(r, i)
    })
    ...
    return r.forEach(function(i) {
      ...
      return {
        ...
        values: t
          .map(function(t, o) {
            ...
            return n.isCustomX() && n.isCategorized() && void 0 !== c
              ? (
              ...
              : (s = n.generateTargetX(
                  ...
                  e,
                  o
                )), (void 0 === t[e] || n.data.xs[e].length <= o) && (s = void 0), { x: s, value: d, id: r }
          })
          .filter(function(t) {
            return p(t.x)
          })
      ...
      a.data_xSort &&
        (t.values = t.values.sort(function(t, e) {
          return (
            (t.x || 0 === t.x ? t.x : 1 / 0) - (e.x || 0 === e.x ? e.x : 1 / 0)
          )
    ...
    }), (n.hasNegativeValue = n.hasNegativeValueInTargets(
      i
    )), (n.hasPositiveValue = n.hasPositiveValueInTargets(i)), a.data_type &&
      n.setTargetType(
    ...
    var e,
      i = this
    return t &&
      ((e = i.config.data_names[t.id]), (t.name = void 0 !== e ? e : t.id)), t
    ...
    return e &&
      (t.sort(e), (this.isOrderAsc() || this.isOrderDesc()) && t.reverse()), t
    ...
    return (i[0] = { x: i[0].x - 1, value: i[0].value, id: i[0].id }), (i[
      t.length + 1
    ] = {
      x: i[t.length].x + 1,
    ...
    t &&
      ...
      ), i.updateTargets(i.data.targets), i.redraw({
      withUpdateOrgXDomain: !0,
      withUpdateXDomain: !0,
      withLegend: !0
    }), e.done && e.done()
    ...
    e || (e = function() {}), (t = t.filter(function(t) {
      ...
      ? (
          ...
          t.forEach(function(t) {
            ;(i.withoutFadeIn[
              t
            ] = !1), i.legend && i.legend.selectAll('.' + r.legendItem + i.getTargetSelectorSuffix(t)).remove(), (i.data.targets = i.data.targets.filter(
              function(e) {
                return e.id !== t
              }
            ))
    ...
    return (v = l(y) ? y : l(w) ? (v < w ? v : w - 10) : v), (b = l(w)
      ? w
      : l(y) ? (y < b ? b : y + 10) : b), 0 === x.length
      ? 'y2' === e ? f.y2.domain() : f.y.domain()
      : (
          isNaN(v) && (v = 0),
          isNaN(b) && (b = v),
          v === b && (v < 0 ? (b = 0) : (v = 0)),
    ...
    var e,
      ...
      s = r.config,
      c = t[1] - t[0]
    return (i = r.isCategorized()
      ? 0
      : r.hasType('bar')
        ? (e = r.getMaxDataCount()) > 1 ? c / (e - 1) / 2 : 0.5
        : 0.01 * c), 'object' === o(s.axis_x_padding) && S(s.axis_x_padding)
      ? (
    ...
    return n - a != 0 ||
      ...
      (e.isTimeSeries()
        ...
        : ((n = 0 === n ? 1 : 0.5 * n), (a = 0 === a ? -1 : 1.5 * a))), (n ||
      0 === n) &&
      (o = e.isTimeSeries()
        ? new Date(n.getTime() - r.left)
        : n - r.left), (a || 0 === a) &&
      (s = e.isTimeSeries() ? new Date(a.getTime() + r.right) : a + r.right), [
      o,
      s
    ]
    ...
    return i &&
      ...
      (
        ...
        o.zoom_enabled && r.zoom.scale(r.x).updateScaleExtent()
      ), n && r.x.domain(r.trimXDomain(r.x.orgDomain())), r.x.domain()
  }), (C.trimXDomain = function(t) {
    var e = this.getZoomDomain(),
      i = e[0],
      n = e[1]
    return t[0] <= i && ((t[1] = +t[1] + (i - t[0])), (t[0] = i)), n <= t[1] &&
      ((t[0] = +t[0] - (t[1] - n)), (t[1] = n)), t
  }), (C.drag = function(t) {
    var e,
      i,
      n,
              ...
              h
                ...
                .each(function(t, e) {
                  ...
                  if (p.classed(r.circle))
                    (i = 1 * p.attr('cx')), (n = 1 * p.attr('cy')), (h =
                      l.togglePoint), (m = o < i && i < s && c < n && n < d)
                  else {
                    if (!p.classed(r.bar)) return
                    ;(i = (f = T(this)).x), (n = f.y), (a = f.width), (u =
                      f.height), (h = l.togglePath), (m = !(
                      s < i ||
                      i + a < o ||
                      d < n ||
                      n + u < c
    ...
    var e = this,
      i = e.config
    return (i.axis_y_tick_format ? i.axis_y_tick_format : e.defaultValueFormat)(
      t
    )
    ...
    ;(t.grid = t.main
      ...
      .attr('class', r.grid)), e.grid_x_show &&
      t.grid.append('g').attr('class', r.xgrids), e.grid_y_show &&
      t.grid.append('g').attr('class', r.ygrids), e.grid_focus_show &&
      t.grid
        .append('g')
        .attr('class', r.xgridFocus)
        .append('line')
        .attr('class', r.xgridFocus), (t.xgrid = i.selectAll(
      []
    ...
    ;(t.gridLines = t.main
      .append('g')
      .attr('clip-path', t.clipPathForGrid)
      .attr('class', r.grid + ' ' + r.gridLines)), t.gridLines
      .append('g')
      .attr('class', r.xgridLines), t.gridLines
      .append('g')
      .attr('class', r.ygridLines), (t.xgridLines = e.selectAll([]))
    ...
    ;(e.xgridAttr = i.axis_rotated
      ...
      .select('.' + r.xgrids)
      .selectAll('.' + r.xgrid)
      .data(a)), e.xgrid.enter().append('line').attr('class', r.xgrid), t ||
    ...
    var e,
      ...
      o = a.main,
      s = a.config
    a.grid.style('visibility', a.hasArcType() ? 'hidden' : 'visible'), o
      .select('line.' + r.xgridFocus)
      .style('visibility', 'hidden'), s.grid_x_show &&
      a.updateXGrid(), (a.xgridLines = o
      .select('.' + r.xgridLines)
      .selectAll('.' + r.xgridLine)
      .data(s.grid_x_lines)), (e = a.xgridLines
      .enter()
      .append('g')
      .attr('class', function(t) {
      ...
      .attr('dy', -5)
      .style('opacity', 0), a.xgridLines
      .exit()
      .transition()
      .duration(t)
      .style('opacity', 0)
      .remove(), s.grid_y_show && a.updateYGrid(), (a.ygridLines = o
      .select('.' + r.ygridLines)
      .selectAll('.' + r.ygridLine)
      .data(s.grid_y_lines)), (i = a.ygridLines
      .enter()
      .append('g')
      .attr('class', function(t) {
      ...
      .attr('dx', a.gridTextDx)
      .attr('dy', -5)
      .style('opacity', 0), (n = a.yv.bind(a)), a.ygridLines
      .select('line')
      .transition()
      .duration(t)
    ...
    if ('year' === t)
      for (
        n = (i = s.getXDomain())[0].getFullYear(), a = i[1].getFullYear(), o = n;
        o <= a;
        o++
      )
    ...
    o.selectAll('.' + r.eventRect).remove(), (i.eventRect = o.selectAll(
      '.' + r.eventRect
    )), a
      ? (
            ...
            : (
                ...
                (r = function(t) {
                  ...
                  return null === e && null === i
                    ? c.axis_rotated ? s.height : s.width
                    : (
    ...
    t
      ...
      .style(
        'cursor',
        n.data_selection_enabled && n.data_selection_grouped ? 'pointer' : null
      )
                ...
                .each(function() {
                  i
                    ...
                    .classed(
                      r.EXPANDED,
                      !0
                    ), n.data_selection_enabled && s.style('cursor', n.data_selection_grouped ? 'pointer' : null), n.tooltip_grouped || (e.hideXGridFocus(), e.hideTooltip(), n.data_selection_grouped || (e.unexpandCircles(o), e.unexpandBars(o)))
                })
                .filter(function(t) {
    ...
    function e() {
      i.svg
        ...
        .style(
          'cursor',
          null
        ), i.hideXGridFocus(), i.hideTooltip(), i.unexpandCircles(), i.unexpandBars()
    }
    var i = this,
      n = i.d3,
      a = i.config
            ...
            o
              ? (
                  (s = (i.isScatterType(o) || !a.tooltip_grouped
                    ? [o]
                    : i.filterByX(c, o.x)).map(function(t) {
                    return i.addName(t)
                  })),
    ...
    return t.config.legend_show &&
      (e = t.isLegendRight
        ? t.currentHeight
        : Math.max(20, t.legendItemHeight) * (t.legendStep + 1)), e
    ...
    i.legend_show ||
      ...
      ), e.removeHiddenLegendIds(t), e.legend
      .selectAll(e.selectorLegends(t))
      .style('visibility', 'visible')
      .transition()
      .style('opacity', function() {
    ...
    i.legend_show &&
      ...
      ), e.addHiddenLegendIds(t), e.legend
      .selectAll(e.selectorLegends(t))
      .style('opacity', 0)
      .style('visibility', 'hidden')
    ...
    function a(e, i, a) {
      function r(t, e) {
        e ||
          ((o = (f - E - g) / 2) < V && ((o = (f - g) / 2), (E = 0), F++)), (D[
          t
        ] = F), (k[F] = b.isLegendInset ? 10 : o), (O[t] = E), (E += g)
      }
      var o,
        s,
        c = 0 === a,
        ...
        f =
          b.isLegendRight || b.isLegendInset
            ? b.getLegendHeight()
            : b.getLegendWidth()
      c && ((E = 0), (F = 0), (C = 0), (L = 0)), !T.legend_show ||
      b.isLegendToShow(i)
        ? (
            (I[i] = u),
            (R[i] = h),
    ...
    ;(t = t.filter(function(t) {
      ...
      .attr('y', b.isLegendRight || b.isLegendInset ? -200 : l), p
      .append('rect')
      .attr('class', r.legendItemEvent)
      .style('fill-opacity', 0)
      .attr('x', b.isLegendRight || b.isLegendInset ? c : -200)
      .attr('y', b.isLegendRight || b.isLegendInset ? -200 : u), p
      .append('line')
      ...
      .attr('stroke-width', T.legend_item_tile_height), (v = b.legend.select(
      '.' + r.legendBackground + ' rect'
    )), b.isLegendInset &&
      C > 0 &&
      0 === v.size() &&
      (v = b.legend
      ...
      .attr('x', s)
      .attr('y', l), (y = b.legend
      .selectAll('rect.' + r.legendItemEvent)
      .data(t)), (_ ? y.transition() : y)
      ...
      .attr('x', c)
      .attr('y', u), (S = b.legend
      .selectAll('line.' + r.legendItemTile)
      .data(t)), (_ ? S.transition() : S)
      .style('stroke', b.color)
      .attr('x1', h)
      .attr('y1', f)
      .attr('x2', g)
      ...
      (_ ? v.transition() : v)
        ...
        .attr('width', C * (F + 1) + 10), b.legend
      .selectAll('.' + r.legendItem)
      .classed(r.legendItemHidden, function(t) {
        return !b.isTargetToShow(t)
      }), b.updateLegendItemWidth(C), b.updateLegendItemHeight(
      L
    ), b.updateLegendStep(
      F
    ), b.updateSizes(), b.updateScales(), b.updateSvgSize(), b.transformAll(
      x,
      i
    ...
    e.region.style(
      ...
      .select('.' + r.regions)
      .selectAll('.' + r.region)
      .data(i.regions)), e.mainRegion
      .enter()
      .append('g')
      .append('rect')
      .style('fill-opacity', 0), e.mainRegion.attr(
      'class',
      e.classRegion.bind(e)
    ...
    return (e =
      'y' === t.axis || 'y2' === t.axis
        ? n.axis_rotated && 'end' in t ? r(t.end) : i.width
        : n.axis_rotated
          ? i.width
          : 'end' in t
    ...
    return (e =
      'y' === t.axis || 'y2' === t.axis
        ? n.axis_rotated ? i.height : 'start' in t ? r(t.start) : i.height
    ...
    var t = this,
      e = t.config,
      i = !t.x
    ;(t.xMin = e.axis_rotated ? 1 : 0), (t.xMax = e.axis_rotated
      ? t.height
      : t.width), (t.yMin = e.axis_rotated
      ? 0
      : t.height), (t.yMax = e.axis_rotated ? t.width : 1), (t.subXMin =
      t.xMin), (t.subXMax = t.xMax), (t.subYMin = e.axis_rotated
      ? 0
      : t.height2), (t.subYMax = e.axis_rotated
      ? t.width2
      : 1), (t.x = t.getX(
      t.xMin,
      t.xMax,
    ...
    )), (t.xAxisTickFormat = t.axis.getXAxisTickFormat()), (t.xAxisTickValues = t.axis.getXAxisTickValues()), (t.yAxisTickValues = t.axis.getYAxisTickValues()), (t.y2AxisTickValues = t.axis.getY2AxisTickValues()), (t.xAxis = t.axis.getXAxis(
      t.x,
      t.xOrient,
      t.xAxisTickFormat,
      t.xAxisTickValues,
    ...
    a.data_onselected.call(n.api, e, t.node()), n.main
    ...
    var n = this
    n.config.data_onunselected.call(n.api, e, t.node()), n.main
      .select('.' + r.selectedCircles + n.getTargetSelectorSuffix(e.id))
      .selectAll('.' + r.selectedCircle + '-' + i)
      .transition()
      .duration(100)
    ...
    var i = this
    i.config.data_onselected.call(i, e, t.node()), i.config
      .interaction_brighten &&
      t.transition().duration(100).style('fill', function() {
        return i.d3.rgb(i.color(e)).brighter(0.75)
      })
  }), (C.unselectPath = function(t, e) {
    var i = this
    i.config.data_onunselected.call(i, e, t.node()), i.config
      .interaction_brighten &&
      t.transition().duration(100).style('fill', function() {
        return i.color(e)
      })
    ...
    return 'circle' === t.nodeName
      ...
      : 'path' === t.nodeName && (i = n.togglePath), i
    ...
    return e.isSplineType(t)
      ? i
      : e.isStepType(t) ? e.config.line_step_type : 'linear'
  }), (C.initLine = function() {
    ...
    ;(e = i.main
      ...
      .style('pointer-events', 'none'))
      .append('g')
      .attr('class', o), e.append('g').attr('class', s), e
      .append('g')
      .attr('class', function(t) {
    ...
    return (a = n.axis_rotated
      ? a.x(c).y(s)
      : a.x(s).y(c)), n.line_connectNull ||
      ...
      f = x.axis_rotated
        ...
        ? function(t, n, r, o) {
            ...
            return (s = x.axis_rotated
              ? [[i(d(r)), e(u)], [i(d(r + o)), e(h)]]
              : [[e(u), i(d(r))], [e(h), i(d(r + o))]]), a(s)
          }
        : function(t, n, r, o) {
            var s
            return (s = x.axis_rotated
              ? [[i(d(r), !0), e(c(r))], [i(d(r + o), !0), e(c(r + o))]]
              : [[e(c(r), !0), i(d(r))], [e(c(r + o), !0), i(d(r + o))]]), a(s)
          }, r = 0;
      r < t.length;
      r++
    ) {
      if (
        ...
        for (
          c = _.getScale(
            ...
            t[r].x + y,
            _.isTimeSeries()
          ), d = _.getScale(t[r - 1].value, t[r].value), l =
            e(t[r].x) - e(t[r - 1].x), u =
            i(t[r].value) - i(t[r - 1].value), g =
            2 * (h = 2 / Math.sqrt(Math.pow(l, 2) + Math.pow(u, 2))), o = h;
          o <= 1;
          o += g
        )
          m += s(t[r - 1], t[r], o, h)
    ...
    return (a = n.axis_rotated
      ? a.x0(c).x1(d).y(s)
      : a.x(s).y0(n.area_above ? 0 : c).y1(d)), n.line_connectNull ||
      (a = a.defined(function(t) {
        return null !== t.value
      })), function(t) {
      var e,
    ...
    ;(t.mainCircle = t.main
      .selectAll('.' + r.circles)
      .selectAll('.' + r.circle)
      .data(t.lineOrScatterData.bind(t))), t.mainCircle
      .enter()
      .append('circle')
      .attr('class', t.classCircle.bind(t))
      .attr('r', t.pointR.bind(t))
      .style('fill', t.color), t.mainCircle.style(
      'opacity',
    ...
    return (e
      ...
      : i.main).selectAll('.' + r.circle + (l(t) ? '-' + t : ''))
  }), (C.expandCircles = function(t, e, i) {
    var n = this,
      a = n.pointExpandedR.bind(n)
    i && n.unexpandCircles(), n
      .getCircles(t, e)
      .classed(r.EXPANDED, !0)
      .attr('r', a)
    ...
    return i.point_focus_expand_enabled
      ? u(i.point_focus_expand_r)
        ...
        : i.point_focus_expand_r ? i.point_focus_expand_r : 1.75 * e.pointR(t)
      : e.pointR(t)
    ...
    return u(i.point_select_r)
      ? i.point_select_r(t)
      : i.point_select_r ? i.point_select_r : 4 * e.pointR(t)
    ...
    return l(i.padding_left)
      ? i.padding_left
      : i.axis_rotated
        ? i.axis_x_show ? Math.max(_(e.getAxisWidthByAxisId('x', t)), 40) : 1
        : !i.axis_y_show || i.axis_y_inner
          ? e.axis.getYAxisLabelPosition().isOuter ? 30 : 1
    ...
    i.style('visibility', n), i
      .append('g')
      .attr('clip-path', t.clipPathForSubchart)
      .attr('class', r.chart), i
      .select('.' + r.chart)
      .append('g')
      .attr('class', r.chartBars), i
      .select('.' + r.chart)
      .append('g')
      .attr('class', r.chartLines), i
      .append('g')
      .attr('clip-path', t.clipPath)
      .attr('class', r.brush)
      .call(t.brush), (t.axes.subx = i
      .append('g')
      .attr('class', r.axisX)
    ...
    ;(e.contextBar = e.context
      .selectAll('.' + r.bars)
      .selectAll('.' + r.bar)
      .data(e.barData.bind(e))), e.contextBar
      .enter()
      .append('path')
      .attr('class', e.classBar.bind(e))
      .style('stroke', 'none')
      .style('fill', e.color), e.contextBar.style(
      'opacity',
      e.initialOpacity.bind(e)
    ...
    ;(e.contextLine = e.context
      .selectAll('.' + r.lines)
      .selectAll('.' + r.line)
      .data(e.lineData.bind(e))), e.contextLine
      .enter()
      .append('path')
      .attr('class', e.classLine.bind(e))
      .style('stroke', e.color), e.contextLine.style(
      'opacity',
      e.initialOpacity.bind(e)
    ), e.contextLine
      .exit()
    ...
    ;(e.contextArea = e.context
      .selectAll('.' + r.areas)
      .selectAll('.' + r.area)
      .data(e.lineData.bind(e))), e.contextArea
      .enter()
      .append('path')
      .attr('class', e.classArea.bind(e))
      .style('fill', e.color)
    ...
    e && e.axisSubX
      ...
      : (
          ...
          t && (i = i.transition())
        ), n.context.attr('transform', n.getTranslate('context')), i.attr(
      'transform',
      n.getTranslate('subx')
    )
    ...
    t.main
      .select('.' + r.chart)
      .append('g')
      .attr('class', r.chartTexts), (t.mainText = t.d3.selectAll([]))
    ...
    return r.config.axis_rotated
      ? (
          (a = r.isBarType(e) ? 4 : 6),
          (n = t[2][1] + a * (e.value < 0 ? -1 : 1))
        )
      : (n = r.hasType('bar') ? (t[2][0] + t[0][0]) / 2 : t[0][0]), null ===
      e.value && (n > r.width ? (n = r.width - o.width) : n < 0 && (n = 4)), n
    ...
    return a.config.axis_rotated
      ...
      (n < r.height
        ? (n = r.height)
        : n > this.height && (n = this.height - 4)), n
    ...
    if (0 !== e.data_groups.length && void 0 === e.tooltip_order) {
      ...
      return (t.isOrderAsc() || t.isOrderDesc()) && (i = i.reverse()), function(
        t,
        e
      ) {
    ...
    for (p && t.sort(p), r = 0; r < t.length; r++)
      if (
        ...
        ;(c = b(
          g(t[r].name, t[r].ratio, t[r].id, t[r].index)
        )), (d = l.levelColor ? l.levelColor(t[r].value) : n(t[r].id)), (a +=
          "<tr class='" +
          l.CLASS.tooltipName +
          '-' +
    ...
    return h
      ? (
          (r =
            (d.width - (d.isLegendRight ? d.getLegendWidth() : 0)) / 2 + g[0]),
          (s = d.height / 2 + g[1] + 20)
        )
      : (
          (a = d.getSvgLeft(!0)),
    ...
    var i = this,
      ...
      a = !1
    return (e = e || i.data.targets), e && e.length
    ...
    ;(e.zoom = i.behavior
      ...
      .on('zoomstart', function() {
        ;(t =
          i.event
            .sourceEvent), (e.zoom.altDomain = i.event.sourceEvent.altKey ? e.x.orgDomain() : null), n.zoom_onzoomstart.call(e.api, i.event.sourceEvent)
      })
      .on('zoom', function() {
    ...
    if (i.zoom_enabled && 0 !== t.filterTargetsToShow(t.data.targets).length) {
      ...
      t.isCategorized() &&
        ...
        a.domain([t.orgXDomain[0] - 1e-10, a.orgDomain()[1]]), t.redraw({
        withTransition: !1,
        ...
        (t.cancelClick = !0), i.zoom_onzoom.call(t.api, a.orgDomain())
    }
  }), L
})
